$(document).ready(function () {
    ...
    $("#hour-25 .time-block").val(localStorage.getItem("25"));
    $("#hour-26 .time-block").val(localStorage.getItem("26"));
    $("#hour-27 .time-block").val(localStorage.getItem("27"));
    $("#hour-28 .time-block").val(localStorage.getItem("28"));
    $("#hour-29 .time-block").val(localStorage.getItem("29"));
    $("#hour-30 .time-block").val(localStorage.getItem("30"));
    $("#hour-31 .time-block").val(localStorage.getItem("31"));
    $("#hour-32 .time-block").val(localStorage.getItem("32"));
});